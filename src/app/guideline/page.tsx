...
export const metadata: Metadata = {
  title: "How to use Castel — Castel",
  description:
    "A quick guide to paying any QRIS merchant in Bali with Castel. Sign in with WhatsApp, top up with your card, and pay from your balance or straight from your card.",
};
    ...
    <main className="mx-auto max-w-md px-6 py-16">
      ...
      <div className="animate-rise">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          Pay any QRIS merchant in Bali straight from your card or a rupiah balance. Here&apos;s
          everything you need in a couple of minutes.
        </p>
      </div>
